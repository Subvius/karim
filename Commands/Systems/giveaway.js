    ...
    options: [
        {
            ...
            options: [
                ...
                {
                    name: "channel",
                    description: "Select the channel where giveaway will be. Default #[🎁] giveaways",
                    type: "CHANNEL",
    ...
    execute(interaction, client) {
        ...
        switch(Sub) {
            ...
            case "manage" : {
                ...
                if (!giveaway) {
                    errorEmbed.setDescription(`Unable to fing the Giveaway with the message id : ${messageId} in this guild.`)
                    return interaction.reply({embeds: [errorEmbed], ephemeral: true})
                }
                switch(choice) {

  ...
  options: [
    {
      name: "ip",
      description:
        "Ip of the server ( mc.hypixel.net or xxx.xxx.x.x port required)",
      type: "STRING",
      required: true,
    },
    {
      ...
      .then((body) => {
        if (body.online === false) {
          const e1 = new MessageEmbed()
            ...
            .addField(
              `**${mcip}** is Currently Offline :sad:`,
              "If this is a mistake join the support server"
            )
            .setTimestamp();
          ...
          const e2 = new MessageEmbed()
            ...
            .addField(
              "Players",
              `${body.players.online}/${body.players.max}` || "none"
            )
            ...
            .setTimestamp()
            .setImage(
              `http://status.mclive.eu/${mcip}/${mcip}/${mcport}/banner.png` ||
                "none"
            );
